...
public:
    InteractiveMarkerNode() : Node("interactive_marker_node")
    {
       ...
       interactive_markers::InteractiveMarkerServer interactive_marker_server_("interactive_marker",this);
        ...
        timer_ = this->create_wall_timer(std::chrono::milliseconds(100), std::bind(&InteractiveMarkerNode::timerCallback, this));
    }

private:
    void createInteractiveMarker(const std::string& name, geometry_msgs::msg::Point& point, bool movable)
    {
